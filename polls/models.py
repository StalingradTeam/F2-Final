...
class QuestionInPoll(models.Model):
    ...
    weight = models.IntegerField(default=1, verbose_name=u'Важность вопроса в опросе') 
...
class Answer(models.Model):
    ...
    score = models.IntegerField(default=0, verbose_name=u'Количество баллов')
...
class Poll(models.Model):
    ...
    public = models.DateField(default=date.today, verbose_name=u'Дата регистрации')
